...
int centerLine = 120; //increased threshold
int max_amp = 30;


int high_dt = 470;  //usually 470
...
void setup() {
  ...
  dt_counter = int(random(300, 1000));
...
Gaussian g1 = Gaussian(0, 10);  //was 0, 0
...
void loop() {
  ...
  // if (coinRand > 0.5) {
  //   coinRand = 0;
  //   dt_counter = low_dt + phase_offset;
  // }
