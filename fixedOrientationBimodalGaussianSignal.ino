...
int fluctuationSignal(int centerline, int fluctuationAvg, Gaussian g1, int sigma);
bool program = true;
int index = 0;
...
int high_dt = 2;// should be 470 TODO
int low_dt = 2;  // should be 470 changes per experiment TODO
...
int sigma = 5;
Gaussian g1 = Gaussian(0, sigma*sigma/4); //was 0, 20 mean, variance. std = 6, bimodal at 2sigma . cut variance in half so two sigma is actually 5
int var = fluctuationSignal(centerLine, max_amp, g1, sigma);
...
void setup() {
  ...
  // phase_offset = int(random(100, 300)); TODO
...
void loop() {
  ...
  if (counter < 2) { //>2 TODO
    if (dt_counter < (high_dt)) {
        ...
        dt_counter = 0;
        var = fluctuationSignal(centerLine, max_amp, g1, sigma);
        // phase_offset = int(random(100, 300)); TODO
...
int fluctuationSignal(int centerline, int fluctuationAvg, Gaussian g1, int sigma) {  //edit this for signal. this one is bimodal
  
  //was 0, 20 mean, variance. std = 6, bimodal at 2sigma
  double var = g1.random();
